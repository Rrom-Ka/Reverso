...
function checkStatusCart(obj){
    ...
    //  console.log(mistakeCounter)
    //  console.log(obj.frontWrapperCart)
    ...
    if (statusArr.length%2==1){
        console.log('rkbr', obj.frontWrapperCart)
        ...
        // obj.wrapperCart.style.transform='perspective(100px) rotateY(180deg)';
    }
       ...
       if (statusArr[beforeLastElement].idCart==statusArr[lastElement].idCart){
        ...
        //    obj.wrapperCart.style.transform='perspective(100px) rotateY(0deg)';
           if (statusArr[beforeLastElement].wrapperContentCart.textContent==statusArr[lastElement].wrapperContentCart.textContent){
            ...
            console.log(statusArr[beforeLastElement].frontWrapperCart)
            console.log(statusArr[beforeLastElement].backWrapperCart)
            console.log(statusArr[lastElement].frontWrapperCart)
            console.log(statusArr[lastElement].backWrapperCart)
           ...
           setTimeout(transformCartBack, 1000, statusArr)
            ...
            // // statusArr[beforeLastElement].wrapperCart.style.transform='perspective(100px) rotateY(0deg)'
            ...
            // statusArr[lastElement].wrapperCart.style.transform='perspective(100px) rotateY(180deg)'
            if (mistakeCounter!=-1){
